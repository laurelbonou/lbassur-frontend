            ...
            <div className="container mx-auto px-6 max-w-7xl relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <motion.div 
                        ...
                        viewport={{ once: true }}
                        className="p-12 border border-white/10 rounded-md bg-white/[0.02] hover:bg-white/[0.04] transition-colors duration-500 flex flex-col group"
                    >
                        <div className="w-14 h-14 border border-white/20 rounded-md flex items-center justify-center mb-8 bg-black">
                            <FileSearch className="text-white" size={24} />
                        </div>
                        <h3 className="text-2xl font-bold text-white mb-4">Comparateur d'Assurance</h3>
                        ...
                        <Link 
                            href="/simulation"
                            className="inline-flex items-center gap-3 text-white text-[13px] font-semibold group-hover:gap-5 transition-all duration-300"
                        >
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold text-white mb-4">Itoju : Santé Connectée</h3>
                        <p className="text-gray-400 font-light leading-relaxed mb-10 flex-1">
